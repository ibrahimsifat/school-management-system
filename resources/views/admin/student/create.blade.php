<x-layouts.app>
    <div class="content-wrapper">
        ...
        <x-contentHeader :$title home='Home' url='student/dashboard' pageTitle="Create Student" />
                        ...
                        <div class="card card-secondary">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body row ">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type='number' class="form-control" id='roll_number' name='roll_number'
                                            required placeholder="Roll Number" value={{ old('roll_number') }}>
                                ...
                                <div class="card-footer">
                                    <x-button type='submit' label='Create Student' class="btn-block" />
                                </div>
                            </form>
                        </div>
