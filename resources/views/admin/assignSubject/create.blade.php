<x-layouts.app>
    <div class="content-wrapper">
        ...
        <x-contentHeader :$title home='Home' url='admin/dashboard' pageTitle="Create AssignSubject" />
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for='name'>Assign Subject Name </label>
                                ...
                                <div class="card-footer">
                                    <x-button type='submit' label='Create AssignSubject' class="btn-block" />
                                </div>
                            </form>
                        </div>
