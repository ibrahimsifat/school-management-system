<x-layouts.app>
    <div class="content-wrapper">
        ...
        <x-contentHeader :$title home='Home' url='guardian/my-account' pageTitle="My Account" />
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type='text' class="form-control" id='occupation' name='occupation'
                                            placeholder="Occupation" value={{ old('occupation', $guardian->gender) }}>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type='text' class="form-control" id='address' name='address'
                                            placeholder="Address" value={{ old('address', $guardian->address) }}>
